...
<body style="text-align:center; margin:0 auto; display:inline; padding-top:100px;">
	<form:form commandName="boardVO" id="detailForm" name="derailForm">
		<!-- 타이틀 -->
		<div id="title">
			<ul>
			<li><img src="<c:url value='/images/egovframwork/example/title_dot.gif'/>" alt=""/>
		...
		<div id="content_pop">
			<div id="table">
			<table width="100%" border="1" cellpadding="0" cellspaceing="0" style=style="bordercolor:#D3E2EC; bordercolordark:#FFFFFF; BORDER-TOP:#C2D0DB 2px solid; BORDER-LEFT:#ffffff 1px solid; BORDER-RIGHT:#ffffff 1px solid; BORDER-BOTTOM:#C2D0DB 1px solid; border-collapse: collapse;">
				<colgroup>
					<col width="150"/>
					<col width="?"/>
				</colgroup>
				...
				<tr>
					...
					<td class="tbtd_content">
						...
						<c:if test="${registerFlag ne 'modify'}">
				...
				<ul>
					<li>
						<span class="btn_blue_l">
							...
							<img src="<c:url value='/image/egovframework/example/btn_bg_r.gif' />" style="margin-left:6px;" alt="" />
						</span>
					</li>
					<li>
						<span class="btn_blue_l">
					...
					<li>
						<span class="btn_blue_l">
							<a href="javascript:document.derailForm.reset();"><spring:message code="button.reset" /></a>
							<img src="<c:url value='/images/egovframework/example/btn_bg_r.gif'/>" style="margin-left:6px;" alt="" />
						</span>
					</li>
				</ul>
